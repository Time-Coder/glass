...
uvec2& uvec2::operator /=(uint value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error when uvec2 v /= float value: value is 0 now.");
	}
...
uvec2 operator /(const uvec2& v1, const uvec2& v2)
{
	if(v2.x == 0)
	{
		throw ZeroDivisionError("Error when uvec2 v1 / uvec2 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw ZeroDivisionError("Error when uvec2 v1 / uvec2 v2: v2.y is 0 now.");
	}
	return uvec2(v1.x / v2.x, v1.y / v2.y);
}
...
uvec2 operator /(const uvec2& v1, const ivec2& v2)
{
	if(v2.x == 0)
	{
		throw ZeroDivisionError("Error when uvec2 v1 / ivec2 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw ZeroDivisionError("Error when uvec2 v1 / ivec2 v2: v2.y is 0 now.");
	}
	return uvec2(v1.x / v2.x, v1.y / v2.y);
}
...
uvec2 operator /(const ivec2& v1, const uvec2& v2)
{
	if(v2.x == 0)
	{
		throw ZeroDivisionError("Error when ivec2 v1 / uvec2 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw ZeroDivisionError("Error when ivec2 v1 / uvec2 v2: v2.y is 0 now.");
	}
	return uvec2(v1.x / v2.x, v1.y / v2.y);
}
...
dvec2 operator /(const uvec2& v, double value)
{
	if(is_zero(value))
	{
		throw ZeroDivisionError("Error when uvec2 v / double value: value is 0 now.");
	}
	return dvec2(v.x / value, v.y / value);
}
...
dvec2 operator /(double value, const uvec2& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec2 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec2 v: v.y is 0 now.");
	}
	return dvec2(value / v.x, value / v.y);
}
...
uvec2 operator /(uint value, const uvec2& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec2 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec2 v: v.y is 0 now.");
	}
	return uvec2(value / v.x, value / v.y);
}
...
uvec2 operator /(int value, const uvec2& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec2 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec2 v: v.y is 0 now.");
	}
	return uvec2(value / v.x, value / v.y);
}
...
uvec3& uvec3::operator /=(const uvec3& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error using uvec3 v1 /= uvec3 v2:\nv2.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error using uvec3 v1 /= uvec3 v2:\nv2.y is 0 now.");
...
uvec3& uvec3::operator %=(uint value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error using uvec3 v %= int value:\nvalue is 0 now.");
	}
	x %= value;
	y %= value;
	z %= value;
...
uvec3 operator /(const uvec3& v1, const uvec3& v2)
{
	if(v2.x == 0)
	{
		throw ZeroDivisionError("Error when uvec3 v1 / uvec3 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw ZeroDivisionError("Error when uvec3 v1 / uvec3 v2: v2.y is 0 now.");
	}
	if(v2.z == 0)
	{
		throw ZeroDivisionError("Error when uvec3 v1 / uvec3 v2: v2.z is 0 now.");
	}
	return uvec3(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
}
...
dvec3 operator /(double value, const uvec3& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec3 v: v.z is 0 now.");
	}
	return dvec3(value / v.x, value / v.y, value / v.z);
}
...
vec3 operator /(float value, const uvec3& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec3 v: v.z is 0 now.");
	}
	return vec3(value / v.x, value / v.y, value / v.z);
}
...
uvec3 operator /(uint value, const uvec3& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec3 v: v.z is 0 now.");
	}
	return uvec3(value / v.x, value / v.y, value / v.z);
}
...
uvec3 operator /(const uvec3& v, int value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error when uvec3 v / int value: value is 0 now.");
	}
	return uvec3(v.x / value, v.y / value, v.z / value);
}
...
uvec3 operator /(int value, const uvec3& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec3 v: v.z is 0 now.");
	}
	return uvec3(value / v.x, value / v.y, value / v.z);
}
...
uvec4& uvec4::operator /=(const uvec4& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error using uvec4 v1 /= uvec4 v2:\nv2.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error using uvec4 v1 /= uvec4 v2:\nv2.y is 0 now.");
...
uvec4& uvec4::operator /=(uint value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error using uvec4 v1 /= int value:\nvalue is 0 now.");
	}
...
uvec4 operator /(const uvec4& v1, const uvec4& v2)
{
	if(v2.x == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v1 / uvec4 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v1 / uvec4 v2: v2.y is 0 now.");
	}
	if(v2.z == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v1 / uvec4 v2: v2.z is 0 now.");
	}
	if(v2.w == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v1 / uvec4 v2: v2.w is 0 now.");
	}
	return uvec4(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w);
}
...
dvec4 operator /(const uvec4& v, double value)
{
	if(is_zero(value))
	{
		throw ZeroDivisionError("Error when uvec4 v / double value: value is 0 now.");
	}
	return dvec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
dvec4 operator /(double value, const uvec4& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw ZeroDivisionError("Error when double value / uvec4 v: v.w is 0 now.");
	}
	return dvec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
vec4 operator /(const uvec4& v, float value)
{
	if(is_zero(value))
	{
		throw ZeroDivisionError("Error when uvec4 v / float value: value is 0 now.");
	}
	return vec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
vec4 operator /(float value, const uvec4& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw ZeroDivisionError("Error when float value / uvec4 v: v.w is 0 now.");
	}
	return vec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
uvec4 operator /(const uvec4& v, uint value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v / uint value: value is 0 now.");
	}
	return uvec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
uvec4 operator /(uint value, const uvec4& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw ZeroDivisionError("Error when uint value / uvec4 v: v.w is 0 now.");
	}
	return uvec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
uvec4 operator /(const uvec4& v, int value)
{
	if(value == 0)
	{
		throw ZeroDivisionError("Error when uvec4 v / int value: value is 0 now.");
	}
	return uvec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
uvec4 operator /(int value, const uvec4& v)
{
	if(v.x == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw ZeroDivisionError("Error when int value / uvec4 v: v.w is 0 now.");
	}
	return uvec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
