...
dvec2 tan(const dvec2& v)
{
	...
	if(is_int(k))
	{
		throw ArithmeticError("v.x can not be (k+0.5)*pi.\nBut v.x = " + str::str(v.x) + " = (" + str::str(int(k)) + "+0.5) * pi now.");
	}
	k = v.y/pi-0.5;
	if(is_int(k))
	{
		throw ArithmeticError("v.y can not be (k+0.5)*pi.\nBut v.y = " + str::str(v.y) + " = (" + str::str(int(k)) + "+0.5) * pi now.");
	}
...
dvec2 asin(const dvec2& v)
{
	if(v.x < -1 || v.x > 1)
	{
		throw ArithmeticError("v.x must be in range [-1, 1].\nBut v.x = " + str::str(v.x) + " now.");
	}
	if(v.y < -1 || v.y > 1)
	{
		throw ArithmeticError("v.y must be in range [-1, 1].\nBut v.y = " + str::str(v.y) + " now.");
	}
...
dvec2 acosh(const dvec2& v)
{
	if(v.x < 1)
	{
		throw ArithmeticError("v.x cannot be less than 1.\nBut now v.x = " + str::str(v.x));
	}
	if(v.y < 1)
	{
		throw ArithmeticError("v.y cannot be less than 1.\nBut now v.y = " + str::str(v.y));
	}
...
dvec2 log(const dvec2& v)
{
	if(v.x <= 0)
	{
		throw ArithmeticError("v.x must be greater than 0.\nBut v.x = " + str::str(v.x) + " now.");
	}
	if(v.y <= 0)
	{
		throw ArithmeticError("v.y must be greater than 0.\nBut v.y = " + str::str(v.y) + " now.");
	}
...
dvec3 tan(const dvec3& v)
{
	...
	if(is_int(k))
	{
		throw ArithmeticError("v.x cannot be (0.5+k)*pi. But now v.x = " + str::str(v.x) + " = (0.5 + " + str::str(int(k)) + ") * pi");
	}

	k = v.y/pi - 0.5;
	if(is_int(k))
	{
		throw ArithmeticError("v.y cannot be (0.5+k)*pi. But now v.y = " + str::str(v.y) + " = (0.5 + " + str::str(int(k)) + ") * pi");
	}

	k = v.z/pi - 0.5;
	if(is_int(k))
	{
		throw ArithmeticError("v.z cannot be (0.5+k)*pi. But now v.z = " + str::str(v.z) + " = (0.5 + " + str::str(int(k)) + ") * pi");
	}
...
dvec3 asin(const dvec3& v)
{
	if(v.x < -1 || v.x > 1)
	{
		throw ArithmeticError("v.x must be in range [-1, 1]. But now v.x = " + str::str(v.x));
	}
	if(v.y < -1 || v.y > 1)
	{
		throw ArithmeticError("v.y must be in range [-1, 1]. But now v.y = " + str::str(v.y));
	}
	if(v.z < -1 || v.z > 1)
	{
		throw ArithmeticError("v.z must be in range [-1, 1]. But now v.z = " + str::str(v.z));
	}
...
dvec3 acosh(const dvec3& v)
{
	if(v.x < 1)
	{
		throw ArithmeticError("v.x cannot be less than 1. But now v.x = " + str::str(v.x));
	}
	if(v.y < 1)
	{
		throw ArithmeticError("v.y cannot be less than 1. But now v.y = " + str::str(v.y));
	}
	if(v.z < 1)
	{
		throw ArithmeticError("v.z cannot be less than 1. But now v.z = " + str::str(v.z));
	}
...
dvec3 log(const dvec3& v)
{
	if(v.x <= 0)
	{
		throw ArithmeticError("v.x must be greater than 0. But now v.x = " + str::str(v.x));
	}
	if(v.y <= 0)
	{
		throw ArithmeticError("v.y must be greater than 0. But now v.y = " + str::str(v.y));
	}
	if(v.z <= 0)
	{
		throw ArithmeticError("v.z must be greater than 0. But now v.z = " + str::str(v.z));
	}
...
dvec4 tan(const dvec4& v)
{
	...
	if(is_int(k))
	{
		throw ArithmeticError("v.w cannot be (0.5 + k) * pi. But now v.w = " + str::str(v.w) + " = (0.5 + " + str::str(int(k)) + ") * pi");
	}
...
dvec4 asin(const dvec4& v)
{
	...
	if(v.w < -1 || v.w > 1)
	{
		throw ArithmeticError("v.w must be in range [-1, 1]. But now v.w = " + str::str(v.w));
	}
...
dvec4 acosh(const dvec4& v)
{
	...
	if(v.w < 1)
	{
		throw ArithmeticError("v.w cannot be less than 1. But now v.w = " + str::str(v.w));
	}
...
dvec4 log(const dvec4& v)
{
	...
	if(v.w <= 0)
	{
		throw ArithmeticError("v.w must be greater than 0. But now v.w = " + str::str(v.w));
	}
