...
// 	{
// 		throw glass::TypeError("Try to insert vector<" + first.parent->_dtype + "> to vector<" + _dtype + ">");
// 	}
...
void GLVector::extend(const GLVector& new_vec)
{
	...
	{
		throw glass::TypeError("Cannot extend vector<" + new_vec._dtype + "> to vector<" + _dtype + ">");
	}
