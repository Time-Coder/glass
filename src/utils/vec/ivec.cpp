...
ivec2& ivec2::operator /=(int value)
{
	if(value == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec2 v /= int value: value is 0 now.");
	}
...
dvec2 operator /(const ivec2& v, double value)
{
	if(is_zero(value))
	{
		throw glass::ZeroDivisionError("Error when ivec2 v / double value: value is 0 now.");
	}
	return dvec2(v.x / value, v.y / value);
}
...
dvec2 operator /(double value, const ivec2& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec2 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec2 v: v.y is 0 now.");
	}
	return dvec2(value / v.x, value / v.y);
}
...
ivec2 operator /(int value, const ivec2& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec2 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec2 v: v.y is 0 now.");
	}
	return ivec2(value / v.x, value / v.y);
}
...
ivec3& ivec3::operator /=(const ivec3& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error using ivec3 v1 /= ivec3 v2:\nv2.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error using ivec3 v1 /= ivec3 v2:\nv2.y is 0 now.");
...
ivec3 operator /(const ivec3& v1, const ivec3& v2)
{
	if(v2.x == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec3 v1 / ivec3 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec3 v1 / ivec3 v2: v2.y is 0 now.");
	}
	if(v2.z == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec3 v1 / ivec3 v2: v2.z is 0 now.");
	}
	return ivec3(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
}
...
ostream& operator <<(ostream& out, const ivec3& v)
{
	out << "ivec3(" << v.x << ", " << v.y << ", " << v.z << ")";
	return out;
}
...
dvec3 operator /(double value, const ivec3& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec3 v: v.z is 0 now.");
	}
	return dvec3(value / v.x, value / v.y, value / v.z);
}
...
vec3 operator /(float value, const ivec3& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec3 v: v.z is 0 now.");
	}
	return vec3(value / v.x, value / v.y, value / v.z);
}
...
uvec3 operator /(uint value, const ivec3& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec3 v: v.z is 0 now.");
	}
	return uvec3(value / v.x, value / v.y, value / v.z);
}
...
ivec3 operator /(const ivec3& v, int value)
{
	if(value == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec3 v / int value: value is 0 now.");
	}
	return ivec3(v.x / value, v.y / value, v.z / value);
}
...
ivec3 operator /(int value, const ivec3& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec3 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec3 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec3 v: v.z is 0 now.");
	}
	return ivec3(value / v.x, value / v.y, value / v.z);
}
...
ivec4& ivec4::operator /=(const ivec4& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error using ivec4 v1 /= ivec4 v2:\nv2.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error using ivec4 v1 /= ivec4 v2:\nv2.y is 0 now.");
...
ivec4& ivec4::operator /=(int value)
{
	if(value == 0)
	{
		throw glass::ZeroDivisionError("Error using ivec4 v1 /= int value:\nvalue is 0 now.");
	}
...
ivec4 operator /(const ivec4& v1, const ivec4& v2)
{
	if(v2.x == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v1 / ivec4 v2: v2.x is 0 now.");
	}
	if(v2.y == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v1 / ivec4 v2: v2.y is 0 now.");
	}
	if(v2.z == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v1 / ivec4 v2: v2.z is 0 now.");
	}
	if(v2.w == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v1 / ivec4 v2: v2.w is 0 now.");
	}
	return ivec4(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w);
}
...
dvec4 operator /(const ivec4& v, double value)
{
	if(is_zero(value))
	{
		throw glass::ZeroDivisionError("Error when ivec4 v / double value: value is 0 now.");
	}
	return dvec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
dvec4 operator /(double value, const ivec4& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw glass::ZeroDivisionError("Error when double value / ivec4 v: v.w is 0 now.");
	}
	return dvec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
vec4 operator /(const ivec4& v, float value)
{
	if(is_zero(value))
	{
		throw glass::ZeroDivisionError("Error when ivec4 v / float value: value is 0 now.");
	}
	return vec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
vec4 operator /(float value, const ivec4& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw glass::ZeroDivisionError("Error when float value / ivec4 v: v.w is 0 now.");
	}
	return vec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
uvec4 operator /(const ivec4& v, uint value)
{
	if(value == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v / uint value: value is 0 now.");
	}
	return uvec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
uvec4 operator /(uint value, const ivec4& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw glass::ZeroDivisionError("Error when uint value / ivec4 v: v.w is 0 now.");
	}
	return uvec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
...
ivec4 operator /(const ivec4& v, int value)
{
	if(value == 0)
	{
		throw glass::ZeroDivisionError("Error when ivec4 v / int value: value is 0 now.");
	}
	return ivec4(v.x / value, v.y / value, v.z / value, v.w / value);
}
...
ivec4 operator /(int value, const ivec4& v)
{
	if(v.x == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec4 v: v.x is 0 now.");
	}
	if(v.y == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec4 v: v.y is 0 now.");
	}
	if(v.z == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec4 v: v.z is 0 now.");
	}
	if(v.w == 0)
	{
		throw glass::ZeroDivisionError("Error when int value / ivec4 v: v.w is 0 now.");
	}
	return ivec4(value / v.x, value / v.y, value / v.z, value / v.w);
}
