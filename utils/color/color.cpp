...
{
    char* lower_name = str::lower(name);
    if(strcmp(lower_name, "red") == 0 || strcmp(lower_name, "r") == 0)
    {
        R = 1.0f;
        // G = 0.0f;
        // B = 0.0f;
    }
    else if(strcmp(lower_name, "green") == 0 || strcmp(lower_name, "g") == 0)
    {
        // R = 0.0f;
        G = 1.0f;
        // B = 0.0f;
    }
    else if(strcmp(lower_name, "blue") == 0 || strcmp(lower_name, "b") == 0)
    {
        // R = 0.0f;
        // G = 0.0f;
        B = 1.0f;
    }
    else if(strcmp(lower_name, "cyan") == 0 || strcmp(lower_name, "c") == 0)
    {
        // R = 0.0f;
        G = 1.0f;
        B = 1.0f;
    }
    else if(strcmp(lower_name, "magenta") == 0 || strcmp(lower_name, "m") == 0)
    {
        R = 1.0f;
        // G = 0.0f;
        B = 1.0f;
    }
    else if(strcmp(lower_name, "yellow") == 0 || strcmp(lower_name, "y") == 0)
    {
        R = 1.0f;
        G = 1.0f;
        // B = 0.0f;
    }
    else if(strcmp(lower_name, "white") == 0 || strcmp(lower_name, "w") == 0)
    {
        R = 1.0f;
        G = 1.0f;
        B = 1.0f;
